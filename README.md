🎵 Audioplayer: A Music Application UI

Tech Stack: Python, Tkinter, Pygame

Description:

Developed a music player application with a graphical user interface (GUI) using Python and Tkinter. *Implemented essential playback controls: Play, Pause, Next, Stop, Start, and Power buttons.
